...
***
*__NOTE:__ If you are not very familiar with SQL commands, it is recommended that you use GIVE-Toolbox to manage data used by GIVE. Detailed manual of GIVE-Toolbox is shown in [3.1. GIVE-Toolbox usages for managing data in GIVE data source](3.1-GIVE-Toolbox-usages.md).*
***
