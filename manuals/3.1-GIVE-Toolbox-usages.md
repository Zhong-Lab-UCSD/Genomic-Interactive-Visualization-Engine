||||
| --- | --- | --- |
| [← 2.2. More detail of GIVE Web Components](2.2-webComponents.md) | [↑ Index](Readme.md) | [3.2. MySQL commands for managing data in GIVE data source →](3.2-dataSource.md) |
...
- `-u <mysqlu>`: (required) MySQL account name
- `-p <mysqlp>`: (Optional) MySQL account passwd. Without '-p', the promot - will ask you to input password.
- `-r <ref>`: (Required) ref genome database name. The ref genome database must has been initialized. If not, please useinitial_ref.sh to do it. 
