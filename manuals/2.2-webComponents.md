||||
| --- | --- | --- |
| [← 2.1. Using GIVE Web Components via GIVE Data Hub](2.1-GIVE-Hub.md) | [↑ Index](Readme.md) | [3.1. GIVE-Toolbox usages for managing data in GIVE data source →](3.1-GIVE-Toolbox-usages.md) |
