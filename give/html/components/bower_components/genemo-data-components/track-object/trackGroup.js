...
var GIVe = (function(give) {
	...
	give.TrackGroup = function(groupID, groupLabel, priority, visibility, singleOnly, idprefix, idpostfix) {
		this.array = [];
		this.map = {};
	...
	give.TrackGroup.prototype.filter = function(callback, thisArg) {
		// filter stuff
		for(var i = 0; i < this.getLength(); i++) {
