...
"Tutorial 0" and "Tutorial 1" show you the easiest way to build a genome browser using #the super link at here did not change color [GIVE Data Hub](https://www.givengine.org/give-hub.html) and tweak it in HTML code. GIVE Data Hub is a public GIVE data source, which hosts hundreds of public/customer data sets, such as ENCODE data. You can easily select data from GIVE Data Hub and it will automatically generate your own genome browser in HTML code. You can edit the HTML code to tweak your genome browser.
...
We provide two approaches for deploying GIVE, which are GIVE-Docker for local machines and custom installation on cloud services. The traditional way is custom installation,however; it is always annoying to configure the dependencies and environments, especially for users lack of Linux administration experience. So we recommend a modern way, GIVE-Docker based on Docker container virtualization technology. You can use GIVE-Docker to deploy GIVE in minutes without any effects to host system. Furthermore, GIVE deployed with GIVE-Docker has the same performance to that system-level installed, and it can be used as a standalone application.
...
This tutorial will teach you how to install GIVE into your Linux system on the local machine. You need to install and configure Apache2, PHP5, MySQL and other softwares and packages. It means that you must have some experience of Linux administration.

## [GIVE Tutorial 3: Use GIVE-Toolbox to manage data tracks](3-GIVE-Toolbox.md)

After deploying GIVE service to your local machine, you can use GIVE-Toolbox to build data tracks from your own data. GIVE-Toolbox provides you several useful script tools for managing data in the back end MySQL. With GIVE-Toolbox, you don't need any MySQL code.
