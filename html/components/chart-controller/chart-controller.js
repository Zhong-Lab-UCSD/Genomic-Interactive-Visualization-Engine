          ...
          <div class="flex layout vertical">
            <div id="coordinateHolder" class="layout vertical">
              ...
              <div class="layout horizontal end-justified" id="controlButtonGroup">
                <paper-button raised="" id="cancelUpdateChartButton" on-tap="_resetTracks">
                  Cancel
                </paper-button>
      ...
      <div class="fit layout vertical">
        ...
        <div class="content flex layout vertical">
          <div class="flex relative">
            <chart-area ref="[[ref]]" id="mainChartArea" coordinate="{{coordinate}}" num-of-subs="{{numOfSubs}}" priority-managers="{{priorityManagers}}" highlight="{{highlight}}" pass-exceptions="">
            </chart-area>
          </div>
