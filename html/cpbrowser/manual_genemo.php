...
<p class="normaltext">You can submit any peak file from your experiment to search the ENCODE database for similar regions across the genome. This may help in finding genomic regions of interest, related epigenetic information or other insights for your research.</p>
...
<ul class="normalnotes">
  ...
  <li>(Optional) If your peak file comes from some analog data (in wig or bigWig format), you may provide a URL of the original file for display purposes in <span class="paper-input-text">Display file URL</span>. This file is used to provide better visualization results and will not be used in computation.</li>
