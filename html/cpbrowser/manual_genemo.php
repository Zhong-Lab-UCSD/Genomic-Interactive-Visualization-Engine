...
<p class="normaltext">GENEMO Search is a genome-wide search engine developed to search the entire genome for similar regions between any given epigenetic signal and known epigenetics study data sets. It is developed by Zhong Lab in University of California, San Diego.</p>
...
<p class="normaltext">You can submit any peak file from your experiment to search ENCODE database for similar regions across the genome. This may help to find genomic regions of interest, related epigenetic information or other insights for your research.</p>
...
<p class="normaltext">ENCODE and mouseENCODE data are incorporated in GENEMO as epigenetic data sets for search and visualization, providing better insights from the vast amount data within the project.</p>
...
<span class="panel"><strong>Figure 2.</strong></span> <span class="genemo-card-title">Search ENCODE data</span> panel in GENEMO Search.</div>
<p class="normaltext">You need to use  <span class="genemo-card-title">Search ENCODE data</span> panel to provide input data in GENEMO Search (see Figure 2 to the right). By specifying the following information, you can search the epigenetic data sets for regions similar to your experiment results:</p>
<ul class="normalnotes">
  ...
  <li>Provide your custom peak file from your experiment. The custom peak file should be in a tab delimited text file, in BED format or any format that has at least three columns: chromosome name, start position and end position. You need to choose one of the following two ways to provide the file:
    <ul>
      <li>You can put your file on any  server publicly accessible and provide the URL in <span class="paper-input-text">URL for data file</span> field;</li>
      <li>You can also directly upload the file with <span class="paper-button-text">Upload local file</span> button. </li>
    </ul>
  (Notice that if you choose one method, any input in the other method will be resetted to avoid interference and confusion. For example, if you upload a local file, the <span class="paper-input-text">URL for data file</span> field will be cleared.)</li>
  ...
  <li>(Optional) If your peak file comes from some analog data (in wig or bigWig format), you may provide a URL of the original file for display purposes in <span class="paper-input-text">Display file URL</span> field. This file is used to provide better visualization results and will not be used in computation.</li>
  <li>(Optional) Choose tracks/data you want to compare by clicking <span class="paper-button-text">Data selection</span> button. (Please refer to <span class="panel">Choose epigenetic data sets to search </span>section below.)</li>
</ul>
<p class="normaltext">After provided the required information, please click <span class="paper-button-text colored">
  <core-icon class="smallInline" icon="search" alt="search"></core-icon>
        Search</span> button to initialize your search.</p>
<div style="clear: both;"></div>
...
<p class="normaltext">GENEMO Search incorporated all data sets from ENCODE project as potential search targets. To choose the specific data sets you would like to search, you can click <span class="paper-button-text">Data selection</span> to open <span class="panel">data selection</span> panel.</p>
...
<ul class="normalnotes">
  <li>Select ENCODE data set individually with the checkboxes in the list;</li>
  <li>Use <strong>Choose sample type</strong> to open <span class="panel">Sample list</span> panel, to choose data sets by sample type;</li>
  <li>Check &quot;Use all ENCODE data&quot; to select all data set to search. (NOTE: the computation time will be quite significant if this checkbox is checked, so providing an email address is strongly recommended.)</li>
</ul>
...
<span class="panel">Figure 4</span>. This example of the output  shows the result from the input file. The <span class="panel">Search ENCODE Data </span>Panel (collapsed), <span class="panel">Gene / Region Selection</span> Panel, <span class="panel">Navigation</span> Panel and <span class="panel">Visualization</span> Panel are shown.</p>
<div style="clear: both;"></div>
