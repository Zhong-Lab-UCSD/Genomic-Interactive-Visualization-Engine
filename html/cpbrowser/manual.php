...
<ul>
  ...
  <li class="style2"><a href="#usage">Using CEpBrowser </a>
    <ul>
      ...
      <li><a href="#trackinformation"></a><a href="#viewquery">View query results in <span class="panel">gene selection</span> panel</a></li>
...
<p class="normaltext">In CEpBrowser (Comparative Epigenome Browser), genomes from multiple species are be shown side by side to enhance the comparison of various features, such as transcript information, epigenomic modifications, SNP's, transcription factor binding sites and so on, aiding users in comparative genomic research. Color-coded regions within every gene context indicates the corresponding aligned part in the species to further help in comparison studies.</p>
<p class="normaltext">CEpBrowser is powered by UCSC Genome Browser (<a href="http://genome.ucsc.edu/" target="_blank">http://genome.ucsc.edu/</a>)<sup><a name="cite1_ref" id="cite1_ref"></a><a href="#cite1">[1]</a></sup> with some source modification and the addition of new epigenomic data in three species: human, mouse and domestic pig.</p>
...
<p class="Header2"><a href="#top"><img src="images/index_sub.png" alt="to index" width="47" height="10" /></a><a name="lookup" id="intro4"></a>Look up genes in <span class="panel">gene query</span> panel</p>
...
<p class="Header2"><a href="#top"><img src="images/index_sub.png" alt="to index" width="47" height="10" /></a><a name="viewquery" id="viewquery"></a>View query results in <span class="panel">gene selection</span> panel</p>
